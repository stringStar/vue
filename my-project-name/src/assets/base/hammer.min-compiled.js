...
!function (a, b, c, d) {
  ...
  function e(a, b, c) {
    ...
    var d,
        e = b.prototype;d = a.prototype = _Object$create(e), d.constructor = a, d._super = e, c && la(d, c);
  }function j(a, b) {
    return function () {
    ...
    var d = b.createEvent("Event");d.initEvent(a, !0, !0), d.gesture = c, c.target.dispatchEvent(d);
      ...
      pa = Math.round,
      qa = Math.abs,
      ra = Date.now;la = "function" != typeof _Object$assign ? function (a) {
  ...
  } : _Object$assign;var sa = h(function (a, b, c) {
    for (var e = _Object$keys(b), f = 0; f < e.length;) {
